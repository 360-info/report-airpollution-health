...
360embed:
  ...
  fragments:
  about: |
    The data in this chart comes from the [Global Burden of Disease (2019)](https://ghdx.healthdata.org/gbd-2019), a 
---
...
filteredData =
  d3.groups(sortedData, d => d.location)
    .map(([key, data]) => ({
      Country: key,
      floor: d3.min([
...
viewTable =
  isWide ?
    ...
    // list view at narrow widths (styled by css)
    html`<div class="list-view">${searchResults.map(c => html`
      <div class="list-card">
        <h3>${c.Country}</h3>
