...
360readme:
  ...
  summary: Visualises the changing risks of heat, cold and ambient air pollution
  repo: report-airpollution-health
  share-url: https://airpollution.360visuals.org/airpollution-temperature
  data-sources: |
    <ul>
      <li><a href="https://ghdx.healthdata.org/gbd-2019">Global Burden of Disease (2019)</a></li>
    </ul>
---
...
![[Creative Commons Attribution Non-Commercial 4.0](https://creativecommons.org/licenses/by-nc/4.0)](https://mirrors.creativecommons.org/presskit/buttons/80x15/png/by-nc.png)

These charts, as well as the analyses that underpin them, are available under a [Creative Commons Attribution Non-Commercial 4.0 licence](https://creativecommons.org/licenses/by-nc/4.0).
